...
export default function App() {
  ...
  const indices = useMemo(() => (result ? representativeIndices(result.classic.terminals) : null), [result]);
    ...
    <div className="app">
      <header className="masthead">
        <div>
          ...
          <p>
            Both strategies bet a multiple λ of the Kelly-optimal fraction f* = p − q/b. Classic holds λ fixed at every
            bankroll. Adaptive slides λ along a sigmoid in current capital — bolder when small, calmer when large. Same
            odds, same coin flips; only the sizing rule differs.
          </p>
        </div>
        <Segmented
